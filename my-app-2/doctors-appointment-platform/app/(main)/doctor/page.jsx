...
export default async function DoctorDashboardPage() {
  ...
  console.log("Doctor page - User data:", {
    id: user?.id,
    role: user?.role,
  ...
  if (user?.role !== "DOCTOR") {
    console.log("Redirecting to onboarding - user is not a doctor");
    redirect("/onboarding");
  }

  // If already verified, redirect to dashboard
  if (user?.verificationStatus !== "VERIFIED") {
    console.log("Redirecting to verification - user is not verified");
    redirect("/doctor/verification");
  }

  console.log("User is verified doctor, loading dashboard data");
